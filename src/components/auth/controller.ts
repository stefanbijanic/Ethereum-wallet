...
export default class AuthController extends BaseController {
    ...
    public async administratorLogin(req: Request, res: Response, next: NextFunction) {
    ...
    async userRefresh(req: Request, res: Response, next: NextFunction) {
        this.refreshTokenByRole("user")(req, res, next);
    }

    async administratorRefresh(req: Request, res: Response, next: NextFunction) {
        this.refreshTokenByRole("administrator")(req, res, next);
    }

    private refreshTokenByRole(role: "user" | "administrator"): (req: Request, res: Response, next: NextFunction) => void {
